...
class MultiTaskLossWrapper_v9(nn.Module):
    ...
    def forward(self, preds, y, x):
        ...
        wtloss_reconstruction_mmd = 1000*(loss_reconstruction+self.hparams.mmd_para*loss_mmd+self.hparams.reg_para*loss_L1_mu)
...
class MTLModelv12(MTLModelv10):
    ...
    def __init__(self, hparams):
        ...
        self.task_Crystal = create_classifier(self.hparams.latent_size, 'Crystal', hidden_layers=2, out_features=26).create()
...
class MTLModelv13(MTLModelv10):
    ...
    def __init__(self, hparams):
        ...
        if self.hparams.train_encoder:
            ...
            self.autoencoder = self._get_model()
            self.autoencoder.freeze()
        self.task_CN = create_mlp(self.hparams.latent_size, 'CN', hidden_layers=2, dropout_first=0.2).create()
        self.task_Dist = create_mlp(self.hparams.latent_size, 'Distances', hidden_layers=2, dropout_first=0.2).create()
        self.task_H2 = create_mlp(self.hparams.latent_size, 'H_fraction', hidden_layers=2, dropout_first=0.2).create()
        self.task_Crystal = create_classifier(self.hparams.latent_size, 'Crystal', hidden_layers=2, out_features=26, dropout_first=0.2, dropout_last=0.2).create()
...
class MTLModelv14(MTLModelv10):
    ...
    def __init__(self, hparams):
        ...
        if self.hparams.train_encoder:
            ...
            self.autoencoder = self._get_model()
            self.autoencoder.freeze()
        self.task_CN = create_mlp_v5(self.hparams.latent_size, 'CN', hidden_layers=2, hidden_features=512).create()
        self.task_Dist = create_mlp_v5(self.hparams.latent_size, 'Distances', hidden_layers=2, hidden_features=512).create()
        self.task_H2 = create_mlp_v5(self.hparams.latent_size, 'H_fraction', hidden_layers=2, hidden_features=512).create()
        self.task_Crystal = create_classifier_v5(self.hparams.latent_size, 'Crystal', hidden_layers=2, hidden_features=512, out_features=26).create()
        self.mtl_loss_func = MultiTaskLossWrapper_v10(4, self.hparams)
    ...
    def setup(self, stage):
        self.train_ds = XasMultiTaskDatasetv2(json_file = self.hparams.train_json_file,
                     root_dir='../data/',
                     descriptor='Distances',
                     MTL=True,
                     scalers=None, scale_min_max=True,
                     cat_list = None,
        ...
        if self.hparams.val_json_file is not None:
            self.val_ds = XasMultiTaskDatasetv2(json_file = self.hparams.val_json_file,
                     root_dir='../data/',
                     descriptor='Distances',
                     MTL=True,
                     scalers=self.train_ds.scalers, scale_min_max=True,
            ...
            self.train_ds, self.val_ds = random_split(self.train_ds,[self.train_size,self.val_size])
    
        if self.hparams.test_json_file:
            self.test_ds = XasMultiTaskDatasetv2(json_file = self.hparams.test_json_file,
                     root_dir='../data/',
                     descriptor='Distances',
                     MTL=True,
                     scalers=self.train_ds.scalers, scale_min_max=True,
    ...
    def val_dataloader(self):
        theo_DL =  DataLoader(self.val_ds, batch_size=self.hparams.batch_size, shuffle=True,
                          num_workers=self.hparams.cpus, drop_last=False, pin_memory=True)
        exp_DL =  DataLoader(self.exp_ds, batch_size=self.hparams.batch_size, shuffle=True,
                          num_workers=self.hparams.cpus, drop_last=False, pin_memory=True)
...
class create_mlp_v5(nn.Module):
    def __init__(self, input_size, descriptor, hidden_layers=1, hidden_features=512, dropout_first=None, dropout_last=None):
        super().__init__()
        ...
        if self.hidden_layers==1:
            self.layers = nn.ModuleList([
                    torch.nn.Linear(in_features=self.input_size, out_features=hidden_features),
                    nn.ReLU(),
                    torch.nn.Linear(in_features=hidden_features, out_features=self.out_features)])
...
class create_classifier_v5(nn.Module):
    ...
    def __init__(self, input_size, descriptor, hidden_layers=1, hidden_features=512, out_features=25, dropout_first=None, dropout_last=None):
        super().__init__()
        self.input_size = input_size
        self.descriptor = descriptor
        self.hidden_layers = hidden_layers
...
class Decoderv3(nn.Module):
    def __init__(self, hparams):
        ...
        self._decoder = nn.Sequential(
                nn.Linear(in_features = hparams.latent_size, out_features = 3*32#self.hparams.hidden_layer_1_dim),
                #nn.ReLU(),

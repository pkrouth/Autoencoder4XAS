...
class VAE(pl.LightningModule):
    def __init__(
        self, hparams, enc_out_dim=96, kl_coeff=0.1, latent_dim=256, lr=1e-4, **kwargs
    ):
        """
...
class VAE_MMD(pl.LightningModule):
    def __init__(self, hparams, enc_out_dim=96, mmd_coeff=0.1, **kwargs):
        """
    ...
    def step(self, batch, batch_idx):
        ...
        samples = Variable(
            torch.randn(200, self.hparams.latent_size, requires_grad=False)
        )

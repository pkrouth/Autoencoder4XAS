#!/usr/bin/env python
# coding: utf-8
#from xas_encoder.models.lightningXAS import Vae2Dsc
from encodex.models.MTLv3 import *
from encodex.models.lightningVAE import VaeMmdConv3Lin1XAS
import warnings
...
def main(hyperparams):
    ...
    model = MTLModelv5(hparams=hparams).float()
    ## Debug
...
if __name__ == '__main__':
    ...
    parser = MTLModelv5.add_model_specific_args(parent_parser)
